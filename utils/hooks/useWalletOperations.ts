import { ACTIVE_CHAINS, PLATFORM_NETWORKS, config } from "../api/config";
import { useAppDispatch, useAppSelector } from "../api/hooks";
import { isEmpty } from "../api/methods";
import { changeAuthor, changeWalletAddress, selectCurrentNetworkSymbol, selectCurrentUser, selectCurrentWallet, selectWalletStatus } from "../api/reducers/auth.reducers";
