...
import {config, FILE_TYPE, PLATFORM_NETWORKS} from "../utils/api/config";
...
export const getLinkPathToJSON = (metadataURI: any, name: any) => {
...
export function abbr(string: any, length = 6, suffix = "...") {
...
export const validateSignature = (text: any, signature: any, secret: any) => {
...
export function decrypt(text: any, secret: any) {
...
export const calcFloorPrice = (items: any) => {
...
export const isSupportedEVMNetwork = (currentNetwork: any) => {
...
export const promiseWithTimeout = (promise: any, ms: any) => {
  let timeoutId: any;
