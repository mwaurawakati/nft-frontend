        ...
        <Layout layoutNoOverflow footerHide>
            <Description
                ...
                statistics={[
                    {
                        label: "",
                        avatar: globalDetailNFT? config.UPLOAD_URL+"uploads/"+globalDetailNFT?.owner?.avatar : "/images/avatar.jpg",
                        history: true,
                        title: "Owner",
                    ...
                    {
                        label: "",
                        avatar: globalDetailNFT? config.UPLOAD_URL+"uploads/"+globalDetailNFT?.creator?.avatar : "/images/avatar.jpg",
                        history: true,
                        title: "Creator",
                    ...
                    <Details
                        ...
                        content={
                            <>
                                ...
                                <strong>{ globalDetailNFT?.name || `this NFT`}</strong>
                            </>
                        }
                        linkUrl="/article"
